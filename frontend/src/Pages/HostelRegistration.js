...
const App = (props) => {
  ...
  const handleChangeRegion = async (event) => {
    ...
    try{
      const response = await fetch('https://final1-o8cm.onrender.com/allAddressDetails', {
        method: 'GET',
        headers: {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      axios.post('https://final1-o8cm.onrender.com/hostel/registration', formData)
      .then((response) => {
        // alert
  ...
  const handleSave1 = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      ...
      axios.post('https://final1-o8cm.onrender.com/hostel/saveform1', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleSave2 = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/hostel/saveform2', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleSave3 = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/hostel/saveform3', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleSave4 = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/hostel/saveform4', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleSave5 = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/hostel/saveform5', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleSave6 = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/hostel/saveform6', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleApprove = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/status_of_hostel_active', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
  ...
  const handleDecline = (e) => {
    ...
    if (Object.keys(formErrors).length === 0) {
      console.log('Form Saved successfully!');
      axios.post('https://final1-o8cm.onrender.com/status_of_hostel_block', formData)
      .then((response) => {
        // alert
        console.log('API response:', response.data);
        alert(response.data);
